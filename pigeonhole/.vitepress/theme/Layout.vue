...
<template>
  <div class="min-h-screen flex flex-col bg-white m-x-32">
    ...
    <div class="mx-auto w-full px-4">
      ...
      <header class="w-full border-b border-gray-400">
        <nav class="flex items-center justify-between py-3">
 	    ...
 	    <a :href="withBase('/index')"><img src="/pigeonhole_logo.png" alt="Pigeonhole" class="h-32 w-auto" /></a>
          </div>
      ...
      <!-- Main content -->
      <main class="w-full mx-auto px-4 py-10 flex">
        <article class="prose w-full mx-auto max-w-8xl flex">
          <Content/>
        </article>
      </main>
    </div>
   ...
   <footer class="max-w-full w-full py-4 text-center text-sm text-gray-500 bg-white">
	   &copy; Dovecot - See <a class="underline" href="https://github.com/dovecot/website" rel="external" target="_blank">https://github.com/dovecot/website</a>
  </footer>
  </div>
</template>
