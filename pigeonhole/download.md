...
-   Download [v2.4.3 **sources**](https://pigeonhole.dovecot.org/releases/2.4/dovecot-pigeonhole-2.4.3.tar.gz) for Dovecot v2.4.3 \[[PGP signature](https://pigeonhole.dovecot.org/releases/2.4/dovecot-pigeonhole-2.4.3.tar.gz.sig)\] \[[changes](https://raw.githubusercontent.com/dovecot/pigeonhole/2.4.3/NEWS)\].
