...
-   Download [v2.4.5 **sources**](https://pigeonhole.dovecot.org/releases/2.4/dovecot-pigeonhole-2.4.5.tar.gz) for Dovecot v2.4.5 \[[PGP signature](https://pigeonhole.dovecot.org/releases/2.4/dovecot-pigeonhole-2.4.5.tar.gz.sig)\] \[[changes](https://raw.githubusercontent.com/dovecot/pigeonhole/2.4.5/NEWS)\].
