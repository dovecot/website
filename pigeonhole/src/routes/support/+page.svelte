<svelte:head>
	<title>Support & Contact - Pigeonhole</title>
</svelte:head>
	...
	<div class="max-w-container-max mx-auto">
		<div class="text-center max-w-2xl mx-auto mb-12">
			...
			<p class="font-body-md text-on-surface-variant">
				Get assistance from the community mailing lists or contact the developer directly.
			</p>
		</div>
		...
		<div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-stretch max-w-4xl mx-auto">
			...
			<div class="bg-surface-container-low p-6 rounded-2xl border border-outline-variant/40 flex flex-col justify-between">
				<div>
					...
					<p class="font-body-md text-sm text-on-surface-variant leading-relaxed mb-6">
						For questions, bug reports, or general Sieve discussions, please use the official Dovecot mailing lists.
					</p>
				</div>
				<div>
					<a
			...
			<div class="bg-surface-container-low p-6 rounded-2xl border border-outline-variant/40 flex flex-col justify-between">
				<div>
					...
					<p class="font-body-md text-sm text-on-surface-variant leading-relaxed mb-6">
						You can contact the primary developer and maintainer of the Pigeonhole project directly for development inquiries:
					</p>
					<div class="bg-black/5 p-4 rounded-lg text-xs space-y-1 mb-6 border border-outline-variant/20 font-mono text-on-surface-variant">
						<p><span class="font-semibold text-on-background">Developer:</span> Stephan Bosch</p>
						<p><span class="font-semibold text-on-background">Email:</span> <span class="select-all text-primary">stephan.bosch at open-xchange dot com</span></p>
					</div>
				</div>
			</div>
		</div>
