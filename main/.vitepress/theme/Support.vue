...
<template>
 <h1 class="text-4xl text-green font-bold m-y-4 text-center">Support</h1>
 <p class="text-xl">
 ...
 <div class="flex flex-wrap">
	 <div class="w-1/4 px-4 py-2 text-center items-center">
		 <h2 class="text-2xl font-bold m-y-4">
			 <img src="/54444-100x100.jpg" class="mx-auto mb-2 w-auto"/>
	 ...
	 <div class="w-1/4 px-4 py-2 text-center items-center">
		 <h2 class="text-2xl font-bold m-y-4">
			 <img src="/3333-100x100.jpg" class="mx-auto mb-2 w-auto"/>
			 <br/>IRC
		 </h2>
		 <p class="text-xl">
	 ...
	 <div class="w-1/4 px-4 py-2 text-center items-center">
	 	 <h2 class="text-2xl font-bold m-y-4">
			 <img src="/1111-100x100.jpg" class="mx-auto mb-2 w-auto"/>
			 <br/>Mailing lists
		 </h2>
		 <p class="text-xl">
                 Find detailed information about our <a href="https://dovecot.org/mailman3/mailman3/lists/dovecot.dovecot.org/" class="underline" rel="external" target="_blank">Mailing List</a>. In case of abuse or other technical issues, contact <a href="mailto:dovecot-owner@dovecot.org" class="underline" rel="external">dovecot-owner@dovecot.org</a> or <a href="https://www.open-xchange.com/contact-us/report-abuse" class="underline" rel="external" target="_blank">Open-Xchange</a>.
		 </p>
